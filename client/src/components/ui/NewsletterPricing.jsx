...
const NewsletterPricing = () => {
    ...
    useEffect(() => {
        if (containerRef.current) {
            ...
            setScrollStart(containerTop - window.innerHeight - 500);
            setScrollEnd(containerTop + window.innerHeight - 1050);
        }
    ...
    return (
        <section
            ...
            ref={containerRef}
            className='bg-zinc-900 py-10 px-4 md:py-[12rem] h-full mb-10 md:mb-40 overflow-hidden'
            style={{
            ...
            <div className='grid grid-cols-12 lg:flex-row gap-20 container mx-auto'>
                <Parallax
                    translateX={['-100%', '0%']}
                    opacity={["0", "1"]}
                    easing='easeInOut'
