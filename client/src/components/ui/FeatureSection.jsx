        ...
        <section id='FeatureSection' className='container relative px-4 md:px-0'>
            <div className='grid gap-10 mb-10 md:mb-40 md:grid-cols-2 md:gap-20'>
                <div className='flex flex-col gap-4 md:items-end md:text-right'>
                    <FaClipboardList size={60} color='' className='text-pink-700 bg-zinc-900 p-3 rounded-full' />
                ...
                <div className='flex flex-col gap-4'>
                    <FaClock size={60} color='' className='text-pink-700 bg-zinc-900 p-3 rounded-full' />
                ...
                <div className='flex flex-col gap-4 md:items-end md:text-right'>
                    <FaBell size={60} color='' className='text-pink-700 bg-zinc-900 p-3 rounded-full' />
                ...
                <div className='flex flex-col gap-4'>
                    <FaUserGear size={60} color='' className='text-pink-700 bg-zinc-900 p-3 rounded-full' />
